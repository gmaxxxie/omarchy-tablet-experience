...
4. **Bar keyboard button in BOTH modes (v1.17)** — the bar's fa-keyboard toggle icon is no longer tablet-only, so laptop users get a one-tap keyboard toggle too.
