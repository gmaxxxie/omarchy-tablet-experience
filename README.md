...
- **Virtual keyboard on the LOCK + LOGIN screens (v1.17, both modes)** — the
  Omarchy **lock screen** now offers BOTH methods: fingerprint, and a
  **"keyboard" button right of the password field** that invokes the on-screen
